...
const CREDITS = [
    {
        ...
        rows: [
            ['Matthew Kanter', 'Adapted'],
            ['Henry Heffernan', 'Original Designer']
        ],
    },
    {
    ...
    },
    {
        ...
        rows: [
            ['Reese Kubricki', 'Mother Dearest: Laura Kanter']
        ],
    },
    {
        title: 'Inspiration',
        rows: [
            ['Henry Heffernan', 'Eric Knocklein']
        ],
    },
];
